 ...
 * 
 */
public class $jqueryui_dialog extends LineFunction {
	...
	private static ParameterCharacter[] definitions = {
			...
			new ParameterCharacter(ParameterCharacter.STROBJECT, null, "action"),
	...
	public void execute(Context context, Writer writer, Object[] args)
		...
		if(StringUtils.isEmpty(template)) template = module.getModuleConfig().getConfig("jqueryui.dialog");
