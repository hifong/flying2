...
public class RSAUtils {
    ...
    public static String getPublicKey(BigInteger modulus, BigInteger publicExponent) throws InvalidKeySpecException, NoSuchAlgorithmException {
    ...
    public static void main(String[] args) throws Exception {
    	...
    	//
    	String pik = getPrivateKey(keys);
    	System.out.println(pik);
    	//
    	
    	//
    	String puk = getPublicKey(keys);
