...
public abstract class StringUtils {
	...
	public static String[] toStringArray(Object[] coll) {
		...
		for(int i=0; i < coll.length; i++) {
			if(coll[i] == null) res[i] = null;
			else if(coll[i] instanceof String) res[i] = (String)coll[i];
			else res[i] = coll[i].toString();
		}
		return res;
	}
	...
	public static String[] toStringArray(Object obj) {
		...
		if(obj.getClass().isArray()) return toStringArray((Object[])obj);
		return null;
	}
	...
	public static String join(Object strs, String spliter) {
		if(strs == null) return null;
		if(!strs.getClass().isArray()) return null;
		StringBuffer sb = new StringBuffer();
		int c = 0;
	...
	public static String getEncoding(String str, String defaultEncoding) {
		String encode;
