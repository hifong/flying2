...
import com.flying.framework.context.ServiceContext.ServiceInfo;
...
public class Logger {
	...
	private final String moduleInfo() {
		if(!OUTPUT_MODULE_INFO || Application.getInstance() == null) return "";
		ServiceContext c = ServiceContext.getContext();
		
		final ServiceInfo si = c.getCurrentServiceInfo();
		if(si != null) {
			return "App:"+ Application.getInstance().getId() + " | TID:" + si.tid + " | ";
		} else {
			return "App:"+ Application.getInstance().getId() + " | TID:- | ";
		}
	}
